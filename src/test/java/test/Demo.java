...
public class Demo {
	public static void main(String[] args) throws InterruptedException {
		...
		enterLocationField.sendKeys("Hyderabad");
		...
		driver.findElement(By.id("search_block")).sendKeys("Roses");
		Thread.sleep(200);
		...
		Thread.sleep(200);
		sortByDropdown.selectByContainsVisibleText("Low to High");
		Thread.sleep(2000);
		...
		cityNameField.clear();
		cityNameField.sendKeys("Shimogha");
		Thread.sleep(1000);
